...
export function BilanComingSoon() {
  return (
    <main
    ...
    >
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-xl font-bold mb-6" style={{ color: '#f9fafb' }}>
          Votre Bilan de clarté arrive bientôt.
        </h1>

        <div className="space-y-4 mb-10 text-left">
          <p className="text-base leading-relaxed" style={{ color: '#d1d5db' }}>
            Une nouvelle version du Bilan est en préparation, pour t&apos;aider à mieux comprendre tes forces, tes ressources et ta direction pour construire ton Plan B.
          </p>
        </div>
